...
defmodule OpenAperture.ProductDeploymentOrchestrator.Supervisor do
  use Supervisor
  ...
  def init([]) do
    ...
    children = [
      ...
      worker(OpenAperture.ProductDeploymentOrchestrator.MessageManager, []),
      worker(OpenAperture.ProductDeploymentOrchestrator.Dispatcher, []),
