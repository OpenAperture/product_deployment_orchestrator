defmodule ProductDeploymentOrchestrator.Mixfile do
  ...
  defp deps do
    [
      ...
      {:openaperture_product_deployment_orchestrator_api, git: "git@github.com:OpenAperture/product_deployment_orchestrator_api.git", ref: "466c1d8b5e73bc7d20316298d716d88c17162f53", override: true},
