defmodule ProductDeploymentOrchestrator.Mixfile do
  ...
  defp deps do
    [
      ...
      {:openaperture_manager_api, git: "https://github.com/OpenAperture/manager_api.git", ref: "41ab8e74bc18f9498b1656a00df7ed2c11b18a94", override: true},
      ...
      {:openaperture_product_deployment_orchestrator_api, git: "https://github.com/OpenAperture/product_deployment_orchestrator_api.git", ref: "f6f8808f6304e16e4569632964376fda6f52e772", override: true},
